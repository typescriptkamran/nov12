...
const Card = () => {
  return (
    <div>
      <div className="relative w-60 h-72 rounded-[50px] bg-zinc-900/90 p-5 m-5">
        <div className="absolute left-0 top-0 rounded-t-[50px] text-xl font-bold text-zinc-300 bg-slate-400 h-15 w-full flex gap-2 py-5 px-5 justify-center">
          <MdMoreTime />
